...
class OpenERPXmlrpc {
   ...
   function read($post = null) {
      ...
      if(empty($post)) {
         ...
         $key = array(new xmlrpcval('name','string')  , new xmlrpcval('user_id','string')  , new xmlrpcval('description','string')  ,new xmlrpcval('duration','string') , new xmlrpcval('date_open', 'datetime'),new xmlrpcval('date_closed','string'));
            ...
            foreach ($scalval as $keys => $values) {
               ...
               $read_html .= '
                     <tr align="center">
                        ...
                        <td>'.$value['description']->scalarval().'</td>
                        <td>'.$value['duration']->scalarval().'</td>
                        <td>'.$value['date_open']->scalarval().'</td>
                         <td>'.$value['date_closed']->scalarval().'</td>
                     </tr>';
            }


var_dump($value['name']->scalarval());
            $read_html .= '</table>';
            return $read_html;
         }
         else {
